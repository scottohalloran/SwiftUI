//
//  AddWordsToTextFile.swift
//  Write-To-Realm-From-CSV
//
//  Created by Scott O'Halloran on 1/21/24.
//

import Foundation

func addWordsToTextFile() {
    var wordString = ""
    ...
    for(word) in wordArray {
        wordString += "Word " + word.irish + "," + word.english + "," + word.type + "\n"
        do {
            try wordString.write(to: filename, atomically: true, encoding: String.Encoding.utf8)
        } catch {
